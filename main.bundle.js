...
/***/ function(module, exports, __webpack_require__) {
	...
	var Runner = function Runner(canvas, context, gameSize) {
	  ...
	  this.audio = {
	    meteorsDestroyed: ['./sounds/wrap-up.wav', './sounds/steve.wav', './sounds/dao.wav'],
	    gameOver: ['./sounds/american.wav', './sounds/tess.wav', './sounds/jeff.wav', './sounds/mejia.wav'],
	...
	var drawObject = function drawObject(image, context, body) {
	  context.drawImage(image, body.center.x - body.size.width / 2, body.center.y - body.size.height / 2, body.size.width, body.size.height);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Board.prototype.changeImpactedMeteorAndObjectStatuses = function () {
	  this.meteors.forEach((function (meteor) {
	    ...
	    } else if (meteor.center.x <= -meteor.size.width / 2 || meteor.center.x >= this.width + meteor.size.width / 2) {
	      this.changeActiveStatus(meteor);
	    }
	  }).bind(this));
	};
